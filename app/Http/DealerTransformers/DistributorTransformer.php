...
class DistributorTransformer extends TransformerAbstract
{
    public function transform(DistributorModel $distributor){
        ...
        return [
            ...
            'front_id' => $distributor->front ? $distributor->front : '',
            'Inside_id' => $distributor->Inside ? $distributor->Inside : '',
            'portrait_id' => $distributor->portrait ? $distributor->portrait : '',
            'national_emblem_id' => $distributor->national_emblem ? $distributor->national_emblem : '',
            'license_id' => $distributor->license ? $distributor->license : '',
