...
class ProductsModel extends BaseModel
{
     ...
     * @var array
     */
    protected $fillable = ['title','tit','category_id','brand_id','brand_id','authorization_id','supplier_id','market_price','sale_price','inventory','cover_id','unit','published','weight','cost_price','summary' , 'product_type'];
