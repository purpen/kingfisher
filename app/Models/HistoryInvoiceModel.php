...
class HistoryInvoiceModel extends BaseModel
{
     ...
     * @var array
     */
    protected $fillable = ['order_id','invoice_id','reviewer','audit','apply','company_phone','opening_bank','bank_account','cover_id','unit_address','duty_paragraph','receiving_address','receiving_name','receiving_phone','prove_id','receiving_id' , 'reason','receiving_type','difference','application_time'];
