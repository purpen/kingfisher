...
class InvoiceModel extends BaseModel
{
     ...
     * @var array
     */
    protected $fillable = ['user_id','company_name','company_phone','reviewer','audit','apply','cover_id','opening_bank','bank_account','unit_address','duty_paragraph','receiving_address','receiving_name','receiving_phone','prove_id','receiving_id' , 'reason','receiving_type','application_time'];
