...
use App\Libraries\Alipay\aop\request\AlipayTradeCloseRequest;
use App\Libraries\Alipay\aop\request\AlipayTradeFastpayRefundQueryRequest;
...
class AlipayTradeService {
	...
	function __construct($alipay_config){
		$this->gateway_url = config('alipay.gatewayUrl'); //获得config文件夹下的alipay.php中的gatewayUrl参数
