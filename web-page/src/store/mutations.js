...
const state = {
  ...
  The_order_Skuid_shopping: [] // skuid
}
...
const mutations = {
  ...
  [THE_ORDER_SKUID_SHOPPING] (state, skuid) {
    state.The_order_Skuid_shopping = skuid
  },
  [THE_ORDER_SKUID_SHOPPING_CLEAR] (state) {
    state.The_order_Skuid_shopping = []
  }
}
