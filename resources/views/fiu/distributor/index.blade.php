    					...
    					<tbody>
    						@foreach ($users as $user)
    							<tr>
    								...
    								<td>
										@if ($user->status == 1)
											<a href="/fiu/saas/user/{{ $user->id}}/unStatus" class="btn btn-sm btn-danger  mr-2r">待审核</a>
										@else
											<a href="/fiu/saas/user/{{ $user->id}}/status" class="btn btn-sm btn-success  mr-2r">已审核</a>
										@endif
