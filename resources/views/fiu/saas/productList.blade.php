                    ...
                    @foreach($products as $product)
                        <tr class="brnone">
                            ...
                            <td>
                                ...
                                <a class="btn btn-default btn-sm" href="{{ url('/fiu/saasProduct/info/') }}?id={{$product->id}}" target="_blank">设置</a>
                                <a class="btn btn-default btn-sm" href="{{ url('/fiu/saas/image') }}?id={{$product->id}}" target="_blank">相关素材</a>
                            </td>
                        </tr>
