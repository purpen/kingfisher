            ...
            <div class="modal-body">
                <form id="updateclassify" class="form-horizontal" role="form" method="POST" action="{{ url('/category/update') }}">
                    ...
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="title" class="form-control float" id="title1" placeholder="请输入分类名或授权条件"  value="{{ old('title') }}">
                            @if ($errors->has('title'))
                        ...
                        <div class="col-md-8 pl-4r ml-3r">
                            <div class="form-inline">
                                <div class="form-group mb-0">
                                    ...
                                    {{--</select>--}}
                                    <input type="text" name="type" class="form-control float" id="type1" value="{{ old('type') }}" readonly style="padding-right: 72.5px">
