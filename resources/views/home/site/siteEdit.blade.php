        ...
        <div class="row">
            <div class="col-md-12">
                <div class="formwrapper">
                    <form id="add-material" role="form" class="form-horizontal" method="post" action="{{ url('/saas/site/update') }}">
						{!! csrf_field() !!}
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="identification" value="{{$site->mark}}">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea  rows="10" cols="20" name="remark" class="form-control">{{$site->remark}}</textarea>
							</div>
						</div>
                        <div class="form-group">
                            <div class="col-sm-12">
