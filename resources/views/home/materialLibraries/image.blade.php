        ...
        <div class="container mainwrap">
            <div class="row">
                <div class="col-md-1">
                    {{--分页数量选择--}}
                    @if(!empty($product_id))
                        <form id="per_page_from" action="{{url('/saas/image')}}?id={{$product_id}}" method="POST">
                    @else
                        <form id="per_page_from" action="{{ url('/saas/image') }}" method="POST">
                    @endif
                        ...
                        @foreach($materialLibraries as $materialLibrary)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    <a class="btn btn-default btn-sm  mr-2r" href="{{ url('/saas/image/edit') }}/{{$materialLibrary->id}}">编辑</a>
