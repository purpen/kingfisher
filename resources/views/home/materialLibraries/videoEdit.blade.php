        ...
        <div class="row">
            <div class="col-md-12">
                <div class="formwrapper">
                    <form id="add-material" role="form" class="form-horizontal" method="post" action="{{ url('/saas/video/update') }}">
						{!! csrf_field() !!}
    					...
    					<h5>商品视频<small class="text-warning">［仅支持后缀(mp4)格式文件,大小50M以内］</small><em>*</em></h5>
                        <hr>
...
@section('customize_js')
	...
	new qq.FineUploader({
		...
		validation: {
			...
			sizeLimit: 52428800 // 50M = 50 * 1024 * 1024 bytes
		},
        messages: {
            typeError: "仅支持后缀['mp4']格式文件",
            sizeError: "上传文件最大不超过50MB"
        },
		//回调函数
		callbacks: {
			//上传完成后
