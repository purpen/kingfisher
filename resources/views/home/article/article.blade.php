                   ...
                   <table class="table table-bordered table-striped">
                        ...
                        @foreach($articles as $article)
                            <tr>
                                ...
                                <td>
                                    @if ($article->status == 1)
                                        <a href="/saas/article/{{ $article->id}}/unStatus" class="btn btn-sm btn-danger  mr-2r">关闭</a>
                                    @else
                                        <a href="/saas/article/{{ $article->id}}/status" class="btn btn-sm btn-success  mr-2r">开启</a>
                                    @endif
