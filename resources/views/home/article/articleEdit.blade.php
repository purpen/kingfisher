        ...
        <div class="row">
            <div class="col-md-12">
                <div class="formwrapper">
                    <form id="add-material" role="form" class="form-horizontal" method="post" action="{{ url('/article/update') }}">
						{!! csrf_field() !!}
    					<h5>基本信息</h5>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="text" class="form-control" name="product_number" value="{{ $article->product_number }}" readonly>
