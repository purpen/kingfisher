<ul class="nav navbar-nav nav-list">
    ...
    <li @if($tab_menu == 'waitsend')class="active"@endif><a style="color: red;border-bottom: 1px solid red;" href="{{url('/invoice/sendOrderList')}}">拒绝</a></li>
    <li @if($tab_menu == 'sended')class="active"@endif><a href="{{url('/invoice/completeOrderList')}}">已过期</a></li>

</ul>
<ul class="nav navbar-nav navbar-right">
    <li>
        <form class="navbar-form navbar-left" role="search" id="search" action="{{url('/invoice/sendOrderList')}}" method="POST">
