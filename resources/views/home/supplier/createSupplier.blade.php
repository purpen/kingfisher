			...
			<div class="col-md-12">
				...
				<form class="form-horizontal" id="add-supplier" role="form" method="post" action="{{ url('/supplier/store') }}">
					...
					{{--</div>--}}
						<div class="form-group {{ $errors->has('bank_address') ? ' has-error' : '' }}">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="inputBank_address" name="bank_address" placeholder="开户行名称">
				...
				<div class="form-group {{ $errors->has('ein') ? ' has-error' : '' }}">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control datetimepicker" name="authorization_deadline" placeholder="授权期限 ">
						</div>
