<ul class="nav navbar-nav nav-list">
    ...
    <li @if($tab_menu == 'approved')class="active"@endif><a href="{{url('/purchase/purchaseStatus')}}?verified=1">主管审核 @if($count['directing']>0)<span class="badge">{{$count['directing']}}</span>@endif</a></li>
