        ...
        <div class="row">
            <div class="col-md-12">
                <div class="formwrapper">
                    ...
                    <form id="add-purchase" role="form" method="post" class="form-horizontal"
                          action="{{ url('/purchase/update') }}">
                        <h5>基本信息</h5>
                        <hr>
                        <div class="form-group">
                            <div class="col-md-10">
                                ...
                                <div class="col-sm-2">
                                    <select class="selectpicker" id="supplier_id" name="supplier_id"
                                            style="display: none;">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-magenta" data-toggle="modal"
                                        id="addpurchase-button">
                                    ＋ 添加采购商品
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="addpurchase" tabindex="-1" role="dialog"
                             aria-labelledby="addpurchaseLabel">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="input-group">
                                            <input id="search_val" type="text" placeholder="请输入SKU编码/商品名称"
                                                   class="form-control">
                                            <span class="input-group-btn">
                  								<button class="btn btn-magenta query" id="sku_search"
                                                        type="button"><span
                                        ...
                                        <div class="form-group mb-0 sublock">
                                            <div class="modal-footer pb-r">
                                                ...
                                                <button type="button" id="choose-sku" class="btn btn-magenta">确定
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    @foreach($purchase_sku_relation as $purchase_sku)
                                        <tr>
                                            <td><img src="" style="height: 50px; width: 50px;" class="img-thumbnail"
                                                     alt="50x50"></td>
                                            ...
                                            <td>
                                                <div style="width:100px;">
                                                    <input type="text" name="price[]"
                                                           class="form-control operate-caigou-blur"
                                                           value="{{$purchase_sku->price}}" placeholder="0.00">
                                                </div>
                                            </td>
                                            <td>
                                                <div style="width:100px;">
                                                    <input type="text" class="form-control integer operate-caigou-blur"
                                                           name="count[]" placeholder=""
                                                           value="{{$purchase_sku->count}}">
                                                </div>
                                            </td>
                                            <td>
                                                <div style="width:100px;">
                                                    <input type="text" class="form-control integer operate-caigou-blur"
                                                           name="freight[]" placeholder=""
                                                           value="{{$purchase_sku->freight}}">
                                                </div>
                                            </td>
                                            <td>
                                                <div style="width:100px;">
                                                    <input type="text" class="form-control integer operate-caigou-blur"
                                                           name="tax_rate[]" placeholder=""
                                                           value="{{$purchase_sku->tax_rate}}">
                                                </div>
                                            </td>
                                    ...
                                    <tr id="append-sku" class="active">
                                        ...
                                        <td colspan="1" class="fb">
                                            <input type="text" class="form-control" id="surcharge" name="surcharge"
                                                   value="{{$purchase->surcharge}}" placeholder="附加费用">
                                        </td>
                                        <td colspan="3" class="fb">采购数量总计：<span class="red"
                                                                                id="skuTotalQuantity">{{$purchase->count}}</span>
                                        </td>
                                        <td colspan="3" class="fb">采购总价：<span class="red"
                                                                              id="skuTotalFee">{{$purchase->price}}</span>元
                                        </td>
                                    </tr>
                                    </tfoot>
                                </table>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <textarea rows="2" class="form-control" name="summary"
                                          id="memo">{{$purchase->summary}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-1">
                                ...
                                <button type="button" class="btn btn-white btn-lg cancel once"
...
@section('load_private')
    ...
    <table class="table table-bordered table-striped">',
        ...
        <tr>',
            '
            <td class="text-center"><input name="Order" class="sku-order" type="checkbox" active="0" value="@{{id}}">
            </td>
            ',
            '
    ...
    <tr>',
        ...
        '
        <td>
            <div class="form-group" style="width:100px;"><input type="text" name="price[]"
                                                                class="form-control operate-caigou-blur"
        ...
        '
        <td>
            <div class="form-group" style="width:100px;"><input type="text"
                                                                class="form-control integer operate-caigou-blur"
                                                                name="count[]" placeholder="采购数量"></div>
        </td>
        ',
        '
        <td>
            <div class="form-group" style="width:100px;"><input type="text" name="freight[]"
                                                                class="form-control operate-caigou-blur freight"
                                                                id="freight" placeholder="运费"></div>
        </td>
        ',
        '
        <td>
            <div class="form-group" style="width:100px;"><input type="text"
                                                                class="form-control integer operate-caigou-blur tax_rate"
                                                                id="tax_rate" name="tax_rate[]" placeholder="税率"></div>
        </td>
        ',
        '
