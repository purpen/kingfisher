...
@section('content')
    ...
    <div class="container mainwrap">
        ...
        @endif
        <form id="add-purchase" role="form" method="post" action="{{ url('/changeWarehouse/update') }}">
                ...
                <div class="well-lg textc mlr-3r mt-r">
                    <table class="table table-striped table-hover" style="margin-bottom:20px;">
                        ...
                        <tr><input type="hidden" name="sku_id[]" value="{{ $sku->sku_id }}">
                            ...
                            <td><div class="form-group"><input type="text" class="form-control integer count" placeholder="输入数量" max_value="{{ $sku->storage_count  }}" name="count[]" value="{{ $sku->count }}"></div></td>
