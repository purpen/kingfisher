        ...
        <div class="modal-body">
            <form id="addsku" class="form-horizontal" method="post" action="{{ url('/enterWarehouse/update') }}">
                <div id="append-sku">
                    ...
                    {{ csrf_field() }}
                    {{--@{{#enter_warehouse}}--}}
                    <input type="hidden" name="enter_warehouse_id" value="{{$enter_warehouse->id}}">
                    <input type="hidden" name="storage_id" value="{{$enter_warehouse->storage_id}}">
                    <input type="hidden" name="purchase_department" value="{{$enter_warehouse->purchase_department}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <p class="form-text">{{ $enter_warehouse->storage_name }}</p>
                        </div>
...
{{--                            @{{#enter_warehouse}}--}}
                            ...
                            <td>未入库：<span id="changetotal" spantotal="0" class="magenta-color">{{$enter_warehouse->not_count}}</span></td>
                            {{--@{{/enter_warehouse}}--}}
                        </tr>
                        </tfoot>
                    </table>
