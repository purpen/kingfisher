                    ...
                    <div class="formwrapper">
                        <form id="add-brand" role="form" method="post" class="form-horizontal" action="{{ url('/receive/storeChannel') }}">
                            ...
                            <div class="form-group" style="position: relative;width: 100%">
                                ...
                                <label for="inputStartTime" class="col-sm-2 control-label">付款时间段</label>
                                <div class="col-sm-3" style="width: 200px">
                                    <input type="text" class="form-control datetimepicker" name="start_time" value="" placeholder="付款时间段 " id="start">
                                </div>
                                ...
                                @endif
                                <label for="inputEndTime" class="col-sm-2 control-label">结算时间段</label>
                                <div class="col-sm-3" style="width: 200px">
                                    <input type="text" class="form-control datetimepicker" name="end_time" value="" placeholder="结算时间段" id="end">
                                </div>
                            ...
                            <div class="form-group mt-3r">
                                <div class="col-sm-6 mt-4r">
                                    <button type="submit" class="btn btn-magenta btn-lg save mr-2r">生成收款单</button>
...
@section('load_private')
    ...
    var distributor_user_id = $("#distributor_user_id").val();
    var start_time = $("input[name='start_time']").val();
    var end_time = $("input[name='end_time']").val();
    if(distributor_user_id == '' && start_time =='' && end_time ==''){
    alert('参数有误');
    }else{
    $.get('/receive/ajaxChannel',{'distributor_user_id':distributor_user_id,'start_time':start_time,'end_time':end_time},function (e) {
    if (e.status){
