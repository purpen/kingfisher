				...
				<div class="modal-dialog modal-zm" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="addDistributorUser" role="form" class="form-horizontal" method="post" action="{{ url('/saas/user/store') }}">
			...
			<div class="modal fade" id="updateDistributor" tabindex="-1" role="dialog" aria-labelledby="updateDistributorLabel">
				<div class="modal-dialog modal-zm" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="updateDistributor" role="form" class="form-horizontal" method="post" action="{{ url('/saas/user/update') }}">
                                <input type="hidden" id="_token" name="_token" value="<?php echo csrf_token(); ?>">
...
@section('customize_js')
	...
	function editDistributor(id) {
		$.get('/saas/user/ajaxEdit',{'id':id},function (e) {
			if (e.status == 1){
	...
	function destroyDistributor (id) {
		if(confirm('确认删除该用户吗？')){
			$.post('/saas/user/destroy',{"_token":_token,"id":id},function (e) {
				if(e.status == 1){
					location.reload();
				}
			},'json');
